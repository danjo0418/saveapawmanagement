...
@section('title')<title>{{ config('app.name') }} | Users Verification </title>@endsection
@section('page')
    ...
    <div class="auto-container mt-3">
        <div class="clearfix">
            <a href="{{ URL::to('admin/users-management') }}" class="text-primary"><i class="fa fa-angle-left"></i> Go to Users Management</a>
