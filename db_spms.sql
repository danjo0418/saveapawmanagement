...
INSERT INTO `claim` (`id`, `pet_id`, `user_id`, `filename`, `witness_email`, `witness_name`, `witness_contact`, `is_delete`, `created_at`, `updated_at`) VALUES
	...
	(2, 10, 10, '1652934095lost.jpg', 'dsad@gmail.com', 'Yawa', '3213213', 0, '2022-05-18 20:21:35', '2022-05-18 20:21:35');
...
-- Dumping data for table db_spms.pets: ~10 rows (approximately)
...
INSERT INTO `users` (`id`, `role_id`, `email`, `password`, `fname`, `mname`, `lname`, `address`, `gender`, `birthday`, `contact`, `own_pet`, `status`, `is_approved`, `profile`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 1, 'saveapawmanagement@gmail.com', '$2y$10$WnvVdQ6XkofYOdlqHyd6pOtFoBVZgb7s.GQMNYyRFxglRQy4xwjke', 'Save', 'A', 'Paw', 'Cordova', 'male', '2022-05-17', '09223763288', 'no', 'active', 1, '1652886860dr_ben.jpg', 'HJEeS2ah9B997Kdiuux7pdwgjOlmRrcjKFmvJ1dcDxxLkXCy3IM0DbsUE1jb', '2022-05-17 05:41:40', '2022-05-18 07:14:20'),
	(2, 2, 'renan@gmail.com', '$2y$10$WnvVdQ6XkofYOdlqHyd6pOtFoBVZgb7s.GQMNYyRFxglRQy4xwjke', 'Renan x', 'Nobleza', 'Escabas', 'Poblacion, Cordov', 'male', '1998-01-01', '0912345678', 'yes', 'active', 1, '1652887200maxresdefault.jpg', 'sI3thn7nk9NI4JWw0vc4Fj19T0Hb1zWUmDuZJUkJT66j1o35Si84xDppsdZW', '2022-05-17 05:42:35', '2022-05-18 17:37:20'),
